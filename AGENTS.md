...
- Elevens webside ligger på https://laerer-test-ny-klasse-slettmeg.test-ny-klasse-slettmeg.studio15.cloud/ — oppgi ALLTID denne adressen når eleven spør hvor websiden er. ALDRI henvis til localhost; det virker ikke på elevens maskin.
